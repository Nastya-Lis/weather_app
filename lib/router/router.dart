...
import 'package:weather_cast/view/details_weather_cast/bloc/details_weather_cast_screen_bloc.dart';
...
final GoRouter router = GoRouter(routes: <RouteBase>[
  ...
  GoRoute(
    ...
    pageBuilder: (context, state) {
      ...
      return CustomTransitionPage(
        child: BlocProvider<DetailsWeatherCastScreenBloc>(
          create: (context) => DetailsWeatherCastScreenBloc(),
          child: DetailsWeatherCastScreen(forecast: forecast,),
        ),
        transitionsBuilder: (BuildContext context, Animation<double> animation,
            Animation<double> secondaryAnimation, Widget child) {
          return child;
